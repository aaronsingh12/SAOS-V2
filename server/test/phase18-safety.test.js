...
test('T5 — the database is unchanged: user_version is still 25 and no table knows about diffs', async () => {
  /*
  ...
  assert.equal(Object.values(getDb().prepare('PRAGMA user_version').get())[0], 25);
