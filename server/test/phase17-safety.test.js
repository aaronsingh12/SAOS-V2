...
test('T7 — the database is unchanged: user_version is still 26 and no table knows about tests', async () => {
  /*
  ...
  assert.equal(Object.values(getDb().prepare('PRAGMA user_version').get())[0], 26);
